...
loader1.load('./tim.glb', function(glb){
  console.log(glb);
...
const al = new THREE.AmbientLight(0x93FF00, 0.2)
al.position.set(20,-10,-5)

scene.add( al )

const wl = new THREE.DirectionalLight(0x93FF00 , 0.2)
...
const spotLight = new THREE.SpotLight( 0x0094FF , 6);
...
const planeMaterial = new THREE.MeshStandardMaterial( { color: 0xFFB681  
} )
